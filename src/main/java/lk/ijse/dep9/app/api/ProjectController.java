...
public class ProjectController {
    ...
    private ProjectDTO createNewProject(@Validated(ValidationGroups.Create.class) ProjectDTO projectDTO,
    ...
    public ProjectDTO getProject(@PathVariable int projectId, @RequestAttribute String username){
