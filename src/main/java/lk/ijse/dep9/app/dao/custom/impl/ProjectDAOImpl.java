...
public class ProjectDAOImpl implements ProjectDAO {
    ...
    public void update(Project project) {
        ...
        try {
            stm = connection.prepareStatement("UPDATE Project SET name = ? AND username = ? WHERE id=?");
            stm.setString(1, project.getName());
            stm.setString(2, project.getUsername());
    ...
    public Optional<?> findById(Integer id) {
        try {
            ...
            if (rst.next()){
                return Optional.of(new Project(rst.getInt("id"), rst.getString("name"),
    ...
    public List<?> findAll() {
        ...
        try {
            ...
            ResultSet rst = stm.executeQuery();
            while(rst.next()){
                projectList.add(new Project(rst.getInt("id"), rst.getString("name"),
                        rst.getString("username")));
            }
            return projectList;
        } catch (SQLException e) {
